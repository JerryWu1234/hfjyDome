      ...
      <div class="detail clearfix">
        <div class="left-side">
          <div class="actor-list">
            <div class="subject">
              <div class="mainpic">
                <a href="#"><img class="movieImg" :src="movieDetail.images.medium" alt="" title="点击查看更多海报"></a>
              </div>
              <div class="info">
          ...
          <div class="insterest-people">
            <div class="top">
            <span><button>想看</button></span>
            <span><button>看过</button></span>
